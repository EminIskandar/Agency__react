...
//img
import background from 'img/Know_background.jpg'
import img1 from 'img/icon/Cup-of-coffe.png'
import img2 from 'img/icon/Awards-new.png'
import img3 from 'img/icon/Projects-done.png'
